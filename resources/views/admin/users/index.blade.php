...
<style>
    ...
    .tbl-shell::-webkit-scrollbar-thumb { background: #9EDD05; border-radius: 10px; }
...
<div class="dashboard-main-body">
    ...
    <!-- Search -->
    <div class="mb-6">
        <div class="rounded-xl bg-white shadow-sm" style="overflow:hidden; border:1px solid #e5e7eb;">
            <div class="p-6">
    ...
    <div style="background:#fff; border-radius:12px; border:1px solid #e5e7eb; box-shadow:0 1px 3px rgba(0,0,0,.06); overflow:hidden; min-width:0; max-width:100%;">
        ...
        <div class="tbl-shell" style="padding:0 1.5rem 1rem;">
            <table style="
                width: max-content;
                min-width: 100%;
