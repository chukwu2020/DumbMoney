...
<body style="margin:0; padding:0; background-color:#f4f8f5; font-family: Arial, Helvetica, sans-serif; color:black;">
  ...
  <div style="display:none; max-height:0; overflow:hidden;">
    {{ $previewText ?? 'You have a new update from Dumb Money.' }}
  </div>
...
<tr>
  <td style="background:#8bc905; padding:15px 10px; text-align:center;">
    <img src="https://res.cloudinary.com/dswwq3xks/image/upload/v1777936379/dumbmoneylogo_ivtjer.png"
         alt="Dumb Money Logo"
         style="height:80px; margin:0 auto; display:block;">
              ...
              <table width="100%" cellpadding="0" cellspacing="0" style="margin-top:35px; border-top:1px solid #e5efe9; padding-top:20px;">
                <tr>
                  <td>
                    ...
                    <p style="margin:5px 0 0; font-size:16px; font-weight:600; color:#8bc905;">The Dumb Money Team</p>
                  </td>
                </tr>
              </table>
          ...
          <tr>
            <td bgcolor="#f0fdf4" style="padding:25px; text-align:center; font-size:12px; color:#5a6d5a;">
              <p style="margin:0 0 10px;">© {{ date('Y') }} Dumb Money. All rights reserved.</p>
              <p style="margin:0;">You are receiving this email because you have an active Dumb Money account.</p>
