...
<style>
    ...
    /* All form labels — always dark readable text */
    .form-section-title {
        font-size: 1.05rem;
        font-weight: 700;
    ...
    /* Features section — crisp white background */
    .features-box {
        background: #ffffff;
    ...
    /* Override any dark card backgrounds the theme might inject */
    .card, .card-body {
        background: #ffffff !important;
        color: #111827 !important;
    }

    /* Ensure labels are always black/dark */
    .form-control, .form-select {
        color: #111827 !important;
        background: #ffffff !important;
    }

    label.text-neutral-900 { color: #111827 !important; }

    /* Feature input row hover */
    .feature-item {
...
<div class="dashboard-main-body">
    <div class="flex flex-wrap items-center justify-between gap-2 mb-6">
        <h6 class="font-semibold mb-0" style="color:var(--brand-dark);">Add Trading Plan</h6>
        <ul class="flex items-center gap-[6px]">
            ...
            <li>-</li>
            <li class="font-medium" style="color:var(--brand-green);">Add Plan</li>
        </ul>
    </div>
            ...
            <form action="{{ route('plans.store') }}" method="POST" id="planForm">
                ...
                <div class="grid md:grid-cols-3 gap-x-5 mb-6">
                    <div class="mb-4">
                        ...
                        <span class="text-danger text-xs">@error('name') {{ $message }} @enderror</span>
                    </div>
                    <div class="mb-4">
                        ...
                        <div class="space-y-2 border border-gray-200 rounded-lg p-3 bg-white">
                            ...
                            <label class="flex items-center gap-2 text-gray-800">
                                <input type="checkbox" name="assets_traded[]" value="{{ $val }}"
                                    {{ is_array(old('assets_traded')) && in_array($val, old('assets_traded')) ? 'checked' : '' }}
                                    class="accent-[#9EDD05]">
                ...
                <div class="features-box mb-6">
                    ...
                    <p class="text-xs text-gray-500 mb-4">
                        <i class="ri-information-line"></i> Each feature will be displayed with a checkmark on the plan card.
                    </p>
                ...
                <div class="grid md:grid-cols-2 gap-x-5 mb-6">
                    ...
                    <div class="mb-4">
                        ...
                        <label class="flex items-center gap-2 text-gray-800">
                            <input type="checkbox" name="popular_badge" value="1" {{ old('popular_badge') ? 'checked' : '' }} class="accent-[#9EDD05]">
