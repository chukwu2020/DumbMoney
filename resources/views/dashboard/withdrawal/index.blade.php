                            ...
                            <div class="bg-white border border-gray-100 rounded-2xl shadow-xl p-5 w-full">
                                ...
                                <div class="space-y-2 text-sm text-gray-700">
                                    ...
                                    <div class="flex justify-between">
                                        ...
                                        <span class="capitalize">{{ ucfirst($withdrawal->status) }}</span>
                                    </div>
                                    <div class="flex justify-between">
...
<style>
    .badge-approved { background-color: #d1fae5; color: #065f46; padding: 0.25rem 0.5rem; border-radius: 9999px; font-weight: 500; font-size: 0.75rem; }
    .badge-pending { background-color: #fef3c7; color: #92400e; padding: 0.25rem 0.5rem; border-radius: 9999px; font-weight: 500; font-size: 0.75rem; }
    .badge-rejected { background-color: #ff6767; color: #fff; padding: 0.25rem 0.5rem; border-radius: 9999px; font-weight: 500; font-size: 0.75rem; }
    .badge-failed { background-color: #fee2e2; color: #b91c1c; padding: 0.25rem 0.5rem; border-radius: 9999px; font-weight: 500; font-size: 0.75rem; }
    .badge-default { background-color: #f3f4f6; color: #374151; padding: 0.25rem 0.5rem; border-radius: 9999px; font-weight: 500; font-size: 0.75rem; }
</style>
@endsection
