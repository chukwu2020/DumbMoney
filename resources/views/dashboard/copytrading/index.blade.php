...
<style>
    ...
    /* ===== PLAN CARDS ===== */
    .plan-grid { display: grid; grid-template-columns: repeat(auto-fill, minmax(320px, 1fr)); gap: 1.5rem; }
    ...
    .plan-card:hover { border-color: var(--primary-green); transform: translateY(-4px); box-shadow: 0 12px 24px rgba(158,221,5,0.15); }
...
.change-trader-btn:disabled {
    ...
    .plan-card.limit-reached:hover { transform: none; box-shadow: none; }
    ...
    /* ===== BADGES & TAGS ===== */
    .style-badge { display: inline-flex; align-items: center; gap: 4px; padding: 4px 12px; border-radius: 30px; font-size: 12px; font-weight: 600; background: #f3f4f6; color: #374151; }
    ...
    @media (max-width: 768px) {
        ...
        button#changeAdminBtn { width: 100%; }
