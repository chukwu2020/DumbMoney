...
<div class="edu-page">
    <style>
        ...
        .edu-page .edu-header {
            ...
            background: linear-gradient(135deg, var(--primary) 0%, #062018 100%);
        ...
        /* Accent override */
        .edu-page .text-primary,
        .edu-page .text-green-600 {
            color: var(--accent) !important;
        }

        /* Background overrides */
        .edu-page .bg-primary,
        .edu-page .bg-green-100 {
            background-color: rgba(139, 201, 5, 0.1) !important;
        }

        .edu-page .psychology-card,
        .edu-page .framework-item,
        .edu-page .tool-card,
        .edu-page .timeline-content {
            border: 1px solid rgba(139, 201, 5, 0.2) !important;
            background: white !important;
        }

        .edu-page .psychology-card:hover {
            border-color: var(--accent) !important;
            box-shadow: 0 20px 30px -12px rgba(139, 201, 5, 0.2) !important;
        }
        ...
        /* .edu-page .sidebar-section a.active {
    background: rgba(139,201,5,0.15) !important;
    color: var(--accent) !important;
    border-left: 3px solid var(--accent) !important;
} */
        /* Borders */
        .edu-page .border-primary {
            border-color: var(--accent) !important;
        }
        ...
        /* ================= THEME OVERRIDES (FINAL FIX) ================= */

        /* Base override */
        .edu-page .mindset-box.themed-box,
        .edu-page .mindset-box.themed-takeaways {
            background: rgba(158, 221, 5, 0.08) !important;
            border: 1px solid rgba(158, 221, 5, 0.25) !important;
            border-left: 4px solid #9EDD05 !important;
        ...
        /* Titles */
        .edu-page .mindset-box.themed-box h5,
        .edu-page .mindset-box.themed-takeaways h5 {
            color: #9EDD05 !important;
            font-weight: 700;
        }

        /* Icons in titles */
        .edu-page .mindset-box.themed-box h5 i,
        .edu-page .mindset-box.themed-takeaways h5 i {
            color: #9EDD05 !important;
        }

        /* List text */
        .edu-page .mindset-box.themed-box li,
        .edu-page .mindset-box.themed-takeaways li {
            color: #0C3A30 !important;
        }

        /* Check icons */
        .edu-page .mindset-box.themed-box li i,
        .edu-page .mindset-box.themed-takeaways li i {
            color: #9EDD05 !important;
        }
        ...
        html {
            ...
            <div  id="intro" class="edu-section p-6 mt-4">
                
                  
                    <h3>Trading Psychology & Risk Control</h3>
    ...
    <section class="padding-bottom padding-top" >
        <div class="container" >
            <div class="row g-5">
                <!-- Main Content Column -->
                <div class="col-lg-8" >
                    <div class="edu-content" data-aos="fade-up" data-aos-duration="800" style=" background-image: url('assets/images/hero/hero-image-1.svg'); background-size: cover; background-position: center;">
                        ...
                        <div id="risk-control" class="edu-section">
                            ...
                            <div class="mindset-box themed-box mt-3">
                        ...
                        <div id="takeaways" class="edu-section">
                            <div class="mindset-box themed-takeaways">
                                <h5>
                                    <i class="ri-star-fill"></i> Key Takeaways
                                </h5>
                                <ul>
                        ...
                        <style>
                            .themed-takeaways {
                                ...
                                /* soft green bg */
                                border: 1px solid rgba(158, 221, 5, 0.25);
                            ...
                            /* Star icon */
                            .themed-takeaways h5 i {
                                color: #9EDD05 !important;
                            }

                            /* List text */
                            .themed-takeaways ul li {
                                color: #0C3A30;
                                /* your dark green */
                                margin-bottom: 6px;
                                font-size: 0.9rem;
                ...
                <div class="col-lg-4">
                    <div class="edu-sidebar" data-aos="fade-left" data-aos-duration="800">
                        ...
                        <div style="background: #0C3A30; border-radius: 16px; padding: 1.2rem; margin-top: 1.5rem;">
                            ...
                            <a href="{{route('user_dashboard')}}" style="background: #8BC905; color: #0C3A30; padding: 0.4rem 1rem; border-radius: 50px; font-size: 0.85rem; font-weight: 600; text-decoration: none; display: inline-block;">Download Template →</a>
                        </div>
                    </div>
                </div>
            </div>
