...
<!-- Start About Area - Compliance Safe Version -->
            ...
            <div class="col-lg-6 col-md-12">
                <div class="about-content pe-lg-5">
                    ...
                    <div class="mb-4">
                        ...
                        <p class="fs-5 text-secondary mb-3" style="line-height:1.7;">
                            <span class="float-start me-2" style="font-size:4rem;line-height:0.8;color:#8BC905;font-weight:800;">M</span>
                            arket Mind is an informational platform focused on sharing financial insights,
                            market trends, and educational resources related to global finance
                            and modern financial technology.
                        </p>

                        <p class="text-secondary mb-3" style="line-height:1.7;">
                            Our goal is to make financial topics easier to understand by providing
                            simplified explanations, market commentary, and educational materials
                            for individuals interested in learning more about finance, digital
                            innovation, and market developments.
                        </p>

                        <div class="p-4 rounded-4 my-4"
                             style="background:rgba(139,201,5,0.04);border-left:4px solid #8BC905;">

                            <p class="mb-0 fst-italic" style="color:#0C3A30;font-weight:500;">
                                "Our mission is to help people better understand financial markets
                                through clear, accessible, and easy-to-read information."
                            </p>
                    ...
                    <div class="mt-4">
                        <ul class="list-unstyled">
                            ...
                            <li class="check-list-item">
                                ...
                                <span style="color:#0C3A30;font-size:1.05rem;">
                                    Insights on digital finance and financial technology
                                </span>
                            </li>
                            ...
                            <li class="check-list-item">
                                ...
                                <span style="color:#0C3A30;font-size:1.05rem;">
                                    Educational resources about global markets
                                </span>
                            </li>
                            ...
                            <li class="check-list-item">
                                ...
                                <span style="color:#0C3A30;font-size:1.05rem;">
                                    Articles and research focused on financial knowledge
                                </span>
                            </li>
                    ...
                    <div class="d-flex flex-wrap align-items-center gap-3 mt-4">
                        ...
                        <span class="small text-secondary">
                            Join 50K+ followers across our social communities
                        </span>
